...
*Defined in [packages/lodestar/src/network/interface.ts:32](https://github.com/ChainSafe/lodestar/blob/53533586a/packages/lodestar/src/network/interface.ts#L32)*
