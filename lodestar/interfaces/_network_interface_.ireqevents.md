...
*Defined in [packages/lodestar/src/network/interface.ts:30](https://github.com/ChainSafe/lodestar/blob/4796680/packages/lodestar/src/network/interface.ts#L30)*
