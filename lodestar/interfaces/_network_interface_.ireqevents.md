...
*Defined in [packages/lodestar/src/network/interface.ts:32](https://github.com/ChainSafe/lodestar/blob/1d5598773/packages/lodestar/src/network/interface.ts#L32)*
