...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/attestations.ts:8](https://github.com/ChainSafe/lodestar/blob/4796680/packages/lodestar/src/db/api/beacon/repositories/attestations.ts#L8)*
