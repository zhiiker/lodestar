...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/attestations.ts:8](https://github.com/ChainSafe/lodestar/blob/2fb982b/packages/lodestar/src/db/api/beacon/repositories/attestations.ts#L8)*
