...
*Defined in [packages/lodestar/src/metrics/metrics.ts:14](https://github.com/ChainSafe/lodestar/blob/ee6564a3a/packages/lodestar/src/metrics/metrics.ts#L14)*
...
*Defined in [packages/lodestar/src/metrics/metrics.ts:13](https://github.com/ChainSafe/lodestar/blob/ee6564a3a/packages/lodestar/src/metrics/metrics.ts#L13)*
...
*Defined in [packages/lodestar/src/metrics/metrics.ts:21](https://github.com/ChainSafe/lodestar/blob/ee6564a3a/packages/lodestar/src/metrics/metrics.ts#L21)*
...
*Defined in [packages/lodestar/src/metrics/metrics.ts:28](https://github.com/ChainSafe/lodestar/blob/ee6564a3a/packages/lodestar/src/metrics/metrics.ts#L28)*
