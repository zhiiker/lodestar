...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:11](https://github.com/ChainSafe/lodestar/blob/6d8273318/packages/lodestar/src/db/api/beacon/repositories/state.ts#L11)*
...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:34](https://github.com/ChainSafe/lodestar/blob/6d8273318/packages/lodestar/src/db/api/beacon/repositories/state.ts#L34)*
...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:46](https://github.com/ChainSafe/lodestar/blob/6d8273318/packages/lodestar/src/db/api/beacon/repositories/state.ts#L46)*
...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:22](https://github.com/ChainSafe/lodestar/blob/6d8273318/packages/lodestar/src/db/api/beacon/repositories/state.ts#L22)*
