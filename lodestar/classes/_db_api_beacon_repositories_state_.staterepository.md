...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:11](https://github.com/ChainSafe/lodestar/blob/4796680/packages/lodestar/src/db/api/beacon/repositories/state.ts#L11)*
...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:33](https://github.com/ChainSafe/lodestar/blob/4796680/packages/lodestar/src/db/api/beacon/repositories/state.ts#L33)*
...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:45](https://github.com/ChainSafe/lodestar/blob/4796680/packages/lodestar/src/db/api/beacon/repositories/state.ts#L45)*
...
*Defined in [packages/lodestar/src/db/api/beacon/repositories/state.ts:21](https://github.com/ChainSafe/lodestar/blob/4796680/packages/lodestar/src/db/api/beacon/repositories/state.ts#L21)*
