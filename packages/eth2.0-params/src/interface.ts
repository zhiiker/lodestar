...
export interface IBeaconParams {
  ...
  // Light client
  BEACON_CHAIN_ROOT_IN_SHARD_BLOCK_HEADER_DEPTH: number;
  BEACON_CHAIN_ROOT_IN_SHARD_BLOCK_HEADER_INDEX: number;
  PERSISTENT_COMMITTEE_ROOT_IN_BEACON_STATE_DEPTH: number;
  PERSISTENT_COMMITTEE_ROOT_IN_BEACON_STATE_INDEX: number;
}
