...
// Light client
export const BEACON_CHAIN_ROOT_IN_SHARD_BLOCK_HEADER_DEPTH = 4;
export const BEACON_CHAIN_ROOT_IN_SHARD_BLOCK_HEADER_INDEX = 0;
export const PERSISTENT_COMMITTEE_ROOT_IN_BEACON_STATE_DEPTH = 5;
export const PERSISTENT_COMMITTEE_ROOT_IN_BEACON_STATE_INDEX = 0;
