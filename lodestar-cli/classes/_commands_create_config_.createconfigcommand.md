...
*Defined in [packages/lodestar-cli/src/commands/create-config.ts:42](https://github.com/ChainSafe/lodestar/blob/905cc824b/packages/lodestar-cli/src/commands/create-config.ts#L42)*
...
*Defined in [packages/lodestar-cli/src/commands/create-config.ts:18](https://github.com/ChainSafe/lodestar/blob/905cc824b/packages/lodestar-cli/src/commands/create-config.ts#L18)*
