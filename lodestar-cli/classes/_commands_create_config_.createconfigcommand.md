...
*Defined in [packages/lodestar-cli/src/commands/create-config.ts:42](https://github.com/ChainSafe/lodestar/blob/6d8273318/packages/lodestar-cli/src/commands/create-config.ts#L42)*
...
*Defined in [packages/lodestar-cli/src/commands/create-config.ts:18](https://github.com/ChainSafe/lodestar/blob/6d8273318/packages/lodestar-cli/src/commands/create-config.ts#L18)*
