[@chainsafe/lodestar-cli](../README.md) › [Globals](../globals.md) › ["lodecli/cmds/beacon/cmds/run/run"](_lodecli_cmds_beacon_cmds_run_run_.md)
...
*Defined in [packages/lodestar-cli/src/lodecli/cmds/beacon/cmds/run/run.ts:22](https://github.com/ChainSafe/lodestar/blob/5f04d592a/packages/lodestar-cli/src/lodecli/cmds/beacon/cmds/run/run.ts#L22)*
